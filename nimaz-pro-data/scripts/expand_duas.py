...
NEW_DUAS = {
    ...
    "Provision & Sustenance": [
        ...
        {
            "title_english": "Pure and Plentiful Provision",
            "title_arabic": "اللهم إني أسألك علما نافعا ورزقا",
            "text_arabic": "اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنْ فَضْلِكَ وَرَحْمَتِكَ، فَإِنَّهُ لَا يَمْلِكُهَا إِلَّا أَنْتَ",
            "transliteration": "Allahumma inni as'aluka min fadlika wa rahmatik, fa innahu la yamlikuha illa anta.",
            "translation": "O Allah, I ask You from Your bounty and mercy, for none possesses them except You.",
            "source": "At-Tabarani",
            "virtue": "Turning to Allah alone for His bounty and mercy.",
            "repeat_count": 1,
        },
    ],
    "Sickness & Healing": [
    ...
    "Comprehensive Duas": [
        ...
        {
            "title_english": "A Heart that is Content",
            "title_arabic": "اللهم إني أسألك نفسا مطمئنة",
            "text_arabic": "اللَّهُمَّ إِنِّي أَسْأَلُكَ نَفْسًا بِكَ مُطْمَئِنَّةً، تُؤْمِنُ بِلِقَائِكَ، وَتَرْضَى بِقَضَائِكَ، وَتَقْنَعُ بِعَطَائِكَ",
            "transliteration": "Allahumma inni as'aluka nafsan bika mutma'innah, tu'minu biliqa'ik, wa tarda biqada'ik, wa taqna'u bi'ata'ik.",
            "translation": "O Allah, I ask You for a soul made tranquil by You, that believes in meeting You, is content with Your decree, and satisfied with what You give.",
            "source": "At-Tabarani",
            "virtue": "A supplication for inner peace and contentment.",
            "repeat_count": 1,
        },
        {
