...
object ScreenTags {
    ...
    const val HadithByGrade = "screen_hadith_by_grade"
    ...
    const val DuaOccasion = "screen_dua_occasion"
    ...
    const val Names = "screen_names"
    const val Favourites = "screen_favourites"
