...
fun MushafPage(
    ...
    // The tooltip, its actions and the translation sheet — shared with MushafLinePage, which
    // draws a different page and means the same thing by a tap.
                    ...
                    Box(
                        ...
                        MushafContinuousText(
                            ...
                            onAyahClick = { ayah, localTapY ->
                                ...
                                actions.show(ayah, (textWindowY - parentWindowY) + localTapY)
                            },
...
@Preview(showBackground = true, name = "Mushaf Page - Al-Fatihah (Light)")
@Composable
private fun MushafPageLightPreview() {
