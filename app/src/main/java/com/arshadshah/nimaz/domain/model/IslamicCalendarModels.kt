...
object IslamicEvents {
    val events = listOf(
        ...
        IslamicEvent(
            ...
            "\u0631\u0623\u0633 \u0627\u0644\u0633\u0646\u0629 \u0627\u0644\u0647\u062c\u0631\u064a\u0629",
            "Islamic New Year",
            "Beginning of the Islamic calendar year",
            1,
            1,
        ...
        IslamicEvent(
            ...
            "\u0639\u0627\u0634\u0648\u0631\u0627\u0621",
            "Day of Ashura",
            "Recommended fasting day, commemorates various historical events",
            1,
            10,
            ...
            null,
            null,
            "Recommended to fast on 9th and 10th or 10th and 11th",
            1
        ),
        ...
        IslamicEvent(
            ...
            null,
            null,
            "Search for it in odd nights of last 10 days",
            2
        ),
        IslamicEvent(
            "laylat_al_qadr_23",
        ...
        IslamicEvent(
            ...
            "\u0644\u064a\u0644\u0629 \u0627\u0644\u0642\u062f\u0631",
            "Laylat al-Qadr (27)",
            "Night of Power - most likely date",
            9,
            27,
            IslamicEventType.NIGHT,
            false,
        ...
        IslamicEvent(
            ...
            "\u064a\u0648\u0645 \u0639\u0631\u0641\u0629",
            "Day of Arafah",
            "Standing at Arafah during Hajj - recommended to fast for non-pilgrims",
            12,
            9,
            IslamicEventType.FAST,
            false,
            ...
            null,
            null,
            "Fasting expiates sins of two years",
            1
        ),
        IslamicEvent(
            "eid_al_adha",
            ...
            null,
            null,
            "Forbidden to fast on this day and 3 days following",
            1
        )
    )
}
