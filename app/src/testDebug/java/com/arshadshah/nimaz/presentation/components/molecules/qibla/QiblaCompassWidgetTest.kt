...
/**
 * Tests for [com.arshadshah.nimaz.presentation.components.molecules.qibla.QiblaCompassWidget].
...
class QiblaCompassWidgetTest {
    ...
    fun rendersSeekingStateWithoutError() {
        composeRule.setThemedContent {
            com.arshadshah.nimaz.presentation.components.molecules.qibla.QiblaCompassWidget(
                qiblaBearing = 119f,
                isFacingQibla = false,
                animatedAzimuth = 30f,
                compassSize = 300.dp
