 ...
 *
 * `PrayerAlarmReceiver` decides whether a prayer makes a sound, plays the adhan, posts silently or is
...
class PrayerAlarmReceiverTest {
    ...
    fun setUp() {
        ...
        preferences = mockk(relaxed = true) {
            ...
            every { adhanRespectDnd } returns this@PrayerAlarmReceiverTest.adhanRespectDnd
            every { notificationVibration } returns this@PrayerAlarmReceiverTest.notificationVibration
            every { notificationReminderMinutes } returns reminderMinutes
            every { adhanEnabled } returns this@PrayerAlarmReceiverTest.adhanEnabled
            every { selectedAdhanSound } returns this@PrayerAlarmReceiverTest.selectedAdhanSound
            ...
            every { fridayReminderEnabled } returns this@PrayerAlarmReceiverTest.fridayReminderEnabled
            every { khatamReminderEnabled } returns this@PrayerAlarmReceiverTest.khatamReminderEnabled
            every { appLanguage } returns this@PrayerAlarmReceiverTest.appLanguage
