...
| `Onboarding` | — | OnboardingScreen — five pages: Welcome, Prayer Times, Learn to Pray, Progress, Permissions. Back returns to the previous page; Get Started or Not Now on page five completes once. |
