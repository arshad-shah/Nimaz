...
/**
 * The Compose test harness for this module's `components.molecules` tests — the three qibla accuracy readouts, whose tests sit in the parent package while their subjects sit in `.qibla`.
 *
