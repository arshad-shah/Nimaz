...
class ObserveLocalEventsUseCaseTest {
    ...
    fun `emits eid card on 1 Shawwal`() = runBlocking {
        ...
        val eidGregorian = com.arshadshah.nimaz.domain.calendar.HijriDateCalculator
            .toGregorian(1, 10, com.arshadshah.nimaz.domain.calendar.HijriDateCalculator.today().year + 1)
