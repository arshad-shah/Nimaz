...
@Composable
// Public for the same reason as the QiblaGeometry draw helpers: the qibla molecules that read
// them stayed in `:app`.
fun accuracyVisuals(accuracy: CompassAccuracy): AccuracyVisuals = when (accuracy) {
...
fun needsCalibration(accuracy: CompassAccuracy) =
